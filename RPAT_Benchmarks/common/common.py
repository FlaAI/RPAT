...
def parse_args(default=False):
    ...
    parser.add_argument('--lam', help='regularization weight (also for RPAT)',
                        default=1.0, type=float)

    ##### Robust Perception Adversarial Training (RPAT as RA in the code for convenience) Configurations #####
    parser.add_argument("--RA", help='apply RPAT',
                        action='store_true')
    parser.add_argument('--RA_start', help='specific epoch to start RPAT',
                        default=0, type=int)
    parser.add_argument('--RA_ip_rate', help='interpolation rate for RPAT',
                        default=0.5, type=float)
